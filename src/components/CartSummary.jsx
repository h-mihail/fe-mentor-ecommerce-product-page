import { toCurrency, useScreenSize } from "../utils";
...
export const AbsoluteCartSummaryWrapper = () => {
  const { isMobile } = useScreenSize();

  return isMobile ? (
    <div className="absolute left-0 right-0 mr-auto ml-auto">
      <CartSummary />
    </div>
  ) : (
    <div className="absolute right-16 w-[450px]">
      <CartSummary />
    </div>
  );
};
